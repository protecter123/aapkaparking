...
class _DuerateState extends State<Duerate> {
  ...
  if (_selectedContainerIndex != null && _controller.text.isNotEmpty && pricingData != null) {
    ...
    try {
      ...
      // MoneyCollection document reference for the admin
      ...
      // int newTotal = int.tryParse(price) ?? 0;
      ...
      //     newTotal = existingTotal + int.tryParse(price)!;
      //   }
      // }

      // // Update or set the dueMoney field
